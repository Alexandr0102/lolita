...
<body>
    <div class="container">
        <form id="quizForm">
            <p>Вы Кристина или Лолита?</p>
            <label><input type="radio" name="person" value="Кристина"> Кристина</label>
            <label><input type="radio" name="person" value="Лолита"> Лолита</label>
            
            <div id="kristinaBlock" class="hidden">
                <p>Кристина сладкая булочка?</p>
                <label><input type="radio" name="kristina" value="Да"> Да</label>
                <label><input type="radio" name="kristina" value="Нет"> Нет</label>
                <p id="kristinaResult" class="hidden"></p>
                <img src="https://i.pinimg.com/736x/c8/cc/24/c8cc24bba37a25c009647b8875aae0e3.jpg" class="cat-img hidden" id="kristinaCat" alt="Котик">
            </div>
            
            <div id="lolitaBlock" class="hidden">
                <p>Лолита сладкая булочка?</p>
                <label><input type="radio" name="lolita" value="Да"> Да</label>
                <label><input type="radio" name="lolita" value="Нет"> Нет</label>
                <p id="lolitaResult" class="hidden"></p>
                <img src="https://i.pinimg.com/736x/c8/cc/24/c8cc24bba37a25c009647b8875aae0e3.jpg" class="cat-img hidden" id="lolitaCat" alt="Котик">
            </div>
        </form>
    </div>
